...
This path uses the [Bounty Marketplace](/docs/api-reference/marketplace-bounties) for the fulfillment lifecycle. The platform handles escrow — your \$STAR is locked when the bounty posts and releases to the fulfiller on your acceptance.
